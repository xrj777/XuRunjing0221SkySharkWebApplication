<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ConfirmRes.aspx.cs" Inherits="XuRunjing0221SkySharkWebApplication.LOB.ConfirmRes" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="tabContents">
           <table>
            <tr>
                <td colspan="2">
                    <asp:Label runat="server" Text="Confirm a Reservation"></asp:Label></td>
                <td></td>
